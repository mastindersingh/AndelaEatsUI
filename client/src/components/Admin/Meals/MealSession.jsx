...
class MealSession extends Component {
  ...
  render(){
    ...
    const { toggleAddEditModal } = this.props;
      ...
      return (
        <div className={`table-body ${isDelete === true ? 'collected' : 'cancelled'}`} >
          <div className="table-row">
            <div className="custom-row">
              ...
              <div className="custom-col-4">
                <button className="edit--color edit" 
                type="button" onClick={(evnt)=>(toggleAddEditModal({
                      name,
                ...
                type="button" onClick={this.showDeleteMealSessionModal}>
                    Delete
                  </button>
              </div>
            </div>
